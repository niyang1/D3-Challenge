...
function xScale(censusData, chosenXAxis) {
    ...
    var xLinearScale = d3.scaleLinear()
      .domain([d3.min(censusData, d => d[chosenXAxis]) * .65,
        d3.max(censusData, d => d[chosenXAxis]) * .95])
      .range([0, width]);
...
function yScale(censusData, chosenYAxis) {
  ...
  var yLinearScale = d3.scaleLinear()
    .domain([d3.min(censusData, d => d[chosenYAxis]) * 0.65,
      d3.max(censusData, d => d[chosenYAxis]) * 0.95])
    .range([height, 0]);
...
d3.csv('./assets/data/data.csv').then(function(censusData) {
    ...
    var h_incomeLabel = xLabelsGroup.append('text')
      .classed('aText', true)
      .classed('inactive', true)
      .attr('x', 0)
      .attr('y', 60)
      ...
      .on('click', function() {
        ...
        if (value != chosenXAxis) {
          ...
          if (chosenXAxis == 'poverty') {
            ...
            h_incomeLabel.classed('active', false).classed('inactive', true);
          }
            ...
            povertyLabel.classed('active', false).classed('inactive', true);
            ageLabel.classed('active', false).classed('inactive', true);
            h_incomeLabel.classed('active', true).classed('inactive', false);
          }
        }
      });
